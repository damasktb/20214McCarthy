...
true.
?- time(s1(Q,100)).
% 131,318 inferences, 0.091 CPU in 0.100 seconds (91% CPU, 1442817 Lips)
...
?- time(s2(Q,100)).
% 145,733 inferences, 0.088 CPU in 0.100 seconds (89% CPU, 1648116 Lips)
...
?- time(s3(Q,100)).
% 147,143 inferences, 0.101 CPU in 0.112 seconds (90% CPU, 1461927 Lips)
...
?- time(s4(Q,100)).
% 137,003 inferences, 0.071 CPU in 0.076 seconds (93% CPU, 1927502 Lips)
Q = [[4,13,17,52]]

?- time(s4(Q,500)).
% 5,156,950 inferences, 5.674 CPU in 5.881 seconds (96% CPU, 908908 Lips)
Q = [[4,13,17,52]]
*/
